...
#pragma region ArithmeticOperators
		...
		{
			return Matrix<3, 3, T>(
				data[0][0] + m.data[0][0], data[1][0] + m.data[1][0], data[2][0] + m.data[2][0],
				data[0][1] + m.data[0][1], data[1][1] + m.data[1][1], data[2][1] + m.data[2][1],
				data[0][2] + m.data[0][2], data[1][2] + m.data[1][2], data[2][2] + m.data[2][2]);
		}
		...
		inline Matrix<3, 3, T> operator*(U scale) const
		{
			...
			return Matrix<3, 3, T>(
				data[0][0] * s, data[1][0] * s, data[2][0] * s,
				data[0][1] * s, data[1][1] * s, data[2][1] * s,
				data[0][2] * s, data[1][2] * s, data[2][2] * s);
		}
		...
		inline Matrix<3, 3, T> operator/(U scale) const
		{
			...
			return Matrix<3, 3, T>(
				data[0][0] * revS, data[1][0] * revS, data[2][0] * revS,
				data[0][1] * revS, data[1][1] * revS, data[2][1] * revS,
				data[0][2] * revS, data[1][2] * revS, data[2][2] * revS);
		}
