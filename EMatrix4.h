...
#pragma region ArithmeticOperators
		...
		{
			return Matrix<4, 4, T>(
				data[0][0] + m.data[0][0], data[1][0] + m.data[1][0], data[2][0] + m.data[2][0], data[3][0] + m.data[3][0],
				data[0][1] + m.data[0][1], data[1][1] + m.data[1][1], data[2][1] + m.data[2][1], data[3][1] + m.data[3][1],
				data[0][2] + m.data[0][2], data[1][2] + m.data[1][2], data[2][2] + m.data[2][2], data[3][2] + m.data[3][2],
				data[0][3] + m.data[0][3], data[1][3] + m.data[1][3], data[2][3] + m.data[2][3], data[3][3] + m.data[3][3]);
		}
		...
		inline Matrix<4, 4, T> operator*(U scale) const
		{
			...
			return Matrix<4, 4, T>(
				data[0][0] * s, data[1][0] * s, data[2][0] * s, data[3][0] * s,
				data[0][1] * s, data[1][1] * s, data[2][1] * s, data[3][1] * s,
				data[0][2] * s, data[1][2] * s, data[2][2] * s, data[3][2] * s,
				data[0][3] * s, data[1][3] * s, data[2][3] * s, data[3][3] * s);
		}
		...
		inline Matrix<4, 4, T> operator/(U scale) const
		{
			...
			return Matrix<4, 4, T>(
				data[0][0] * revS, data[1][0] * revS, data[2][0] * revS, data[3][0] * revS,
				data[0][1] * revS, data[1][1] * revS, data[2][1] * revS, data[3][1] * revS,
				data[0][2] * revS, data[1][2] * revS, data[2][2] * revS, data[3][2] * revS,
				data[0][3] * revS, data[1][3] * revS, data[2][3] * revS, data[3][3] * revS);
		}
